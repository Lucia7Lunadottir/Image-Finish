...
class ToolOptionsBar(QWidget):
    ...
    def _build_pages(self):
        ...
        self._pages["Blur"]    = EffectOptions("opts.effect.blur",    show_hardness=True)
        self._pages["Sharpen"] = EffectOptions("opts.effect.sharpen", show_hardness=True)
        self._pages["Smudge"]  = EffectOptions("opts.effect.smudge",  show_hardness=True)
